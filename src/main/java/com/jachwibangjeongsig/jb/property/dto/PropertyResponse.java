...
public record PropertyResponse(
	...
	String direction, String description, LocalDateTime createdAt, LocalDateTime updatedAt
) {
	public static PropertyResponse from(Property property) {
		return new PropertyResponse(property.getId(), property.getName(), property.getAddress(),
			...
			property.getDeposit(), property.getMonthlyRent(), property.getExclusiveArea(),
			property.getFloor(), property.getTotalFloors(), property.getBuildYear(),
